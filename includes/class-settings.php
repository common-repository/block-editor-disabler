...
if ( ! class_exists( 'BEDP_Class_Settings' ) ) {
	class BEDP_Class_Settings {
		...
		public function disable_gutenberg_settings_init() {
			...
			add_settings_section( 'disable_gutenberg_section', 'Disable Gutenberg Editor', '', 'bedp_settings' );
		...
		public function register_admin_setting_page() {
			add_menu_page( 'BEDP Settings', 'Block Editor Settings', 'manage_options', 'dgep-settings-page', array( $this, 'render_settings_page' ), 'dashicons-remove', '21' );
		}
